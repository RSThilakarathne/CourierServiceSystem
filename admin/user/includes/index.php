...
if (isset($_POST['submit'])) {
  ...
  if($type==='admin')
    ...
    if($type==='user')
    {
       ...
       if($type==='delivery')
    {
       $res=mysqli_query($conn,"SELECT * FROM `delivery` WHere email='$email' And password='$password'");
...
<!--  <?php
  ...
  if($ros)
  {
    ...
    echo"<script>alert('login sucess');window.location='C:\xampp\htdocs\01\user\order.php'</script>";
  }
  else {
